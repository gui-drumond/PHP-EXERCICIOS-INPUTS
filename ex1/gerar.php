                        ...
                        for($terceiro=0;$terceiro<$tres;$terceiro++)
                        {
                            for($quarto=0;$quarto<$quatro;$quarto++)
                            {
                                for($quinto=0;$quinto<$cinco;$quinto++)
                                {
                                    ...
                                    { 
                                        $combinacoes++; $soma=$primeiro+$segundo+$terceiro+$quarto+$quinto+$sexto;
                                    }    
                                }
                            }
                        }
                    }
                } echo '<tr class="text-center">'."<td>"."  "."<h3>SOMA: $soma</h3>".$primeiro." - ".$segundo." - ".$terceiro." - ".$quarto." - ".$quinto." - ".$sexto."<h3>TOTAL: $combinacoes combinacoes</h3>"."</td>"."</tr>";
            ?>
        </table>
