...
<body>
    ...
    <div class="container">
        <h1 class="display-4 mt-5">EXERCICIO5</h1>
        <hr>
        <form action="ex5_resposta.php" method="POST">
            <div class="form-group col-6">
                <label for="n1">Insira seu numero primeiro</label>
                <input type="number" class="form-control" name="n1" placeholder="Ex: 1">
            </div>
            <div class="form-group col-6">
                <label for="n2">Insira segundo numero</label>
                <input type="number" class="form-control" name="n2" placeholder="Ex: 2">
            </div>
