...
<body>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto text-center">
                        ...
                        <li class="nav-item active">
                            <a class="nav-link" href="emprestimo.php">Empréstimo</a>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <div class="container">
        <h1 class="display-4 mt-5">Empréstimo de Livros</h1>
        <hr>
        <form action="recibo.php" method="POST">
            ...
            <div class="form-group col-6">
                <label for="livro">Insira o nome do livro</label>
                <input type="text" class="form-control" name="livro" require="required" placeholder="Ex: Livro - Não há dia fácil">
            </div>
            <div class="form-group col-6 ">
                ...
                <small class="text-muted">Aluno: é 3 dias de empréstimo | Professor: é 10 dias de empréstimo</small>
            </div>
